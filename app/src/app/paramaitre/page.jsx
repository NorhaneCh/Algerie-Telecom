        ...
        <div>
                        ...
                        <div>
                          ...
                          {toggle && (
                            ...
                            >
                              ...
                              <button
                                className="py-1 px-3 rounded-md h-9 bg-gray-500 text-white hover:bg-gray-600 mt-9"
                          ...
                          {users.map((user, i) => (
                            ...
                            >
                              ...
                              >
                                ...
                                <button
                                  className="py-1 px-3 rounded-md h-9 bg-gray-500 text-white hover:bg-gray-600"
                                  onClick={() =>
                                    handleUpdatePass(user.username)
                                  }
                                >
                                  Réinitialiser
                                </button>
                        ...
                        <div className="border-r border-light-gray w-1/3">
                          ...
                          <div className="flex flex-row gap-2 items-center justify-center mt-9 px-2">
                            <label className="flex flex-col w-[100%] mx-auto">
                              <input
                                type="text"
                                placeholder="Marque d'imprimante"
                                value={addedImprMarque}
                                onChange={(e) =>
                                  setAddedImprMarque(e.target.value)
                                }
                                className="border-2 rounded-md py-1 pl-2 font-medium border-light-gray"
                              />
                            </label>
                            ...
                            {imprMarques?.map((ImprMarque, i) => (
                              ...
                              >
                                ...
                                <button
                                  className="ml-auto px-2 text-red-600 rounded-full bg-gray-300 hover:bg-gray-400 text-[22px] font-bold"
                                  onClick={() =>
                                    deleteImprMarque(ImprMarque.name)
                                  }
                                >
                                  -
                                </button>
                        ...
                        <div className="border-r border-light-gray w-1/3">
                          ...
                          <div className="flex flex-row gap-2 items-center justify-center mt-9 px-2">
                            <label className="flex flex-col w-[100%] mx-auto">
                              <input
                                type="text"
                                placeholder="Marque du Pc"
                                value={addedPcMarque}
                                onChange={(e) =>
                                  setAddedPcMarque(e.target.value)
                                }
                                className="border-2 rounded-md py-1 pl-2 font-medium border-light-gray"
                              />
                            </label>
          ...
          {session && !session.user.isAdmin && (
            <motion.div
              ...
              className="text-center h-screen flex flex-col gap-9"
            >
